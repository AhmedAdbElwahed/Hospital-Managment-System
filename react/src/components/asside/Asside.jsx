...
export default function Asside({control}) {
        ...
        <div
            ...
            <section className='w-full h-full flex  gap-1 text-black   flex-col'>
                {items.map((item, index) => (
                    <div onClick={() => updatedItems(item.id)} key={index} className='w-full  flex'>
                        ...
                        <div
                            className={`${item.selection ? 'bg-[#4880FF] ' : 'bg-[#fff] '} px-4 w-full mx-5 cursor-pointer flex items-center gap-5 text-white rounded-lg`}>
                            <Link to={item.path} className="flex w-full h-full py-4">
                            <img src={item.icon} alt="" className="w-[24px] h-[24px] mr-2"
            ...
            <section className='w-full flex flex-col gap-1 bg-white'>
                <div
                    ...
                    <div
                        className={` ${id === 5 ? 'bg-[#4880FF] text-white' : 'bg-[#fff] text-[#000]'}   px-4 w-full mx-5 cursor-pointer flex items-center gap-5 text-black rounded-lg`}>
                        <Link to="/settings" className="flex w-full h-full py-4">
                        <svg style={{filter: id === 5 ? 'invert(100%)' : 'invert(0%)'}} className="mr-2"
